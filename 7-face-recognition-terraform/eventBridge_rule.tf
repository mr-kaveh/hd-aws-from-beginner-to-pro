# This rule listens for events generated by Amazon S3. 
# Specifically, it "monitors" API calls that are logged via CloudTrail.
resource "aws_cloudwatch_event_rule" "s3_upload_rule" {
  name        = "s3-upload-rule"
  description = "Triggers Step Function on S3 upload"
...
# This resource specifies what action should be taken when the event rule is triggered.
...
# This role allows AWS EventBridge to assume the role.
